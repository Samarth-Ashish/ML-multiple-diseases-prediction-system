...
DISEASE_CONFIG = {
    ...
    'kidney': {
        ...
        'fields': [
            ...
            {'name': 'pcc', 'min': 0, 'max': 1, 'default': 0, 'help': 'Pus Cell Clumps. 0=Not Present, 1=Present', 'type': 'select', 'options': ['Not Present', 'Present']},
            ...
            {'name': 'pcv', 'min': 0, 'max': 60, 'default': 44, 'help': 'Packed Cell Volume (%). Normal: 36-48', 'type': 'number'},
            {'name': 'wc', 'min': 0, 'max': 30000, 'default': 8000, 'help': 'White Blood Cell Count (cells/cumm). Normal: 4000-11000', 'type': 'number'},
            {'name': 'rc', 'min': 0, 'max': 10, 'default': 5.0, 'step': 0.1, 'help': 'Red Blood Cell Count (millions/cumm). Normal: 4.5-5.5', 'type': 'number'},
            {'name': 'htn', 'min': 0, 'max': 1, 'default': 0, 'help': 'Hypertension. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'dm', 'min': 0, 'max': 1, 'default': 0, 'help': 'Diabetes Mellitus. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'cad', 'min': 0, 'max': 1, 'default': 0, 'help': 'Coronary Artery Disease. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'appet', 'min': 0, 'max': 1, 'default': 1, 'help': 'Appetite. 0=Poor, 1=Good', 'type': 'select', 'options': ['Poor', 'Good']},
            {'name': 'pe', 'min': 0, 'max': 1, 'default': 0, 'help': 'Pedal Edema. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'ane', 'min': 0, 'max': 1, 'default': 0, 'help': 'Anemia. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
        ]
    },
    'liver': {
        'name': 'Liver Disease',
    ...
    'hypothyroid': {
        ...
        'fields': [
            ...
            {'name': 'on thyroxine', 'min': 0, 'max': 1, 'default': 0, 'help': 'Currently on thyroxine treatment. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'query on thyroxine', 'min': 0, 'max': 1, 'default': 0, 'help': 'Query regarding thyroxine. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'on antithyroid medication', 'min': 0, 'max': 1, 'default': 0, 'help': 'On antithyroid medication. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'sick', 'min': 0, 'max': 1, 'default': 0, 'help': 'Currently sick. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'pregnant', 'min': 0, 'max': 1, 'default': 0, 'help': 'Pregnant. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'thyroid surgery', 'min': 0, 'max': 1, 'default': 0, 'help': 'History of thyroid surgery. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'I131 treatment', 'min': 0, 'max': 1, 'default': 0, 'help': 'I131 treatment history. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'query hypothyroid', 'min': 0, 'max': 1, 'default': 0, 'help': 'Query regarding hypothyroidism. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'query hyperthyroid', 'min': 0, 'max': 1, 'default': 0, 'help': 'Query regarding hyperthyroidism. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'lithium', 'min': 0, 'max': 1, 'default': 0, 'help': 'On lithium treatment. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'goitre', 'min': 0, 'max': 1, 'default': 0, 'help': 'Goitre present. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'tumor', 'min': 0, 'max': 1, 'default': 0, 'help': 'Tumor present. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'hypopituitary', 'min': 0, 'max': 1, 'default': 0, 'help': 'Hypopituitary condition. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
            {'name': 'psych', 'min': 0, 'max': 1, 'default': 0, 'help': 'Psychological symptoms. 0=No, 1=Yes', 'type': 'select', 'options': ['No', 'Yes']},
